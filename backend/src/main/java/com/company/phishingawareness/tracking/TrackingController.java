...
public class TrackingController {
    ...
    private static final String TRAINING_HTML = "<!DOCTYPE html><html lang='es'><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'>"
            ...
            + "<h1 style='color:#1e293b;margin:18px 0 8px;font-size:24px'>Caiste en una simulacion de phishing</h1>"
            + "<p style='color:#475569;font-size:15px;line-height:1.55;margin:0 0 6px'>Este mensaje formaba parte del programa interno de concienciacion. "
            + "Ningun dato salio de tu cuenta y no hubo consecuencias: el objetivo es que aprendas a detectar el siguiente intento real.</p>"
            + "<h2 style='color:#1e293b;font-size:17px;margin:24px 0 10px'>Senales que debias notar</h2>"
            + "<ul style='color:#334155;font-size:14.5px;line-height:1.65;padding-left:20px;margin:0'>"
            + "<li><strong>Urgencia o amenaza:</strong> avisos de bloqueo, caducidad o verificacion en 24 horas buscan que actues sin pensar.</li>"
            + "<li><strong>Remitente:</strong> dominios parecidos pero alterados (empresa-soporte.com, cuenta.gmail-verify.co) o direcciones con numeros.</li>"
            + "<li><strong>Saludos genericos:</strong> 'Estimado cliente' en vez de tu nombre.</li>"
            ...
            + "Simulacion: {SLUG} · Programa de concienciacion de seguridad</div>"
            + "<form id='training-quiz' style='margin-top:24px;border-top:1px solid #e2e8f0;padding-top:20px'>"
            + "<h2 style='color:#1e293b;font-size:17px;margin:0 0 14px'>Comprobacion rapida (3 preguntas)</h2>"
            + "<p style='font-weight:700;color:#334155;font-size:14px;margin:14px 0 6px'>1. Un correo urgente te pide confirmar tu contrasena 'hoy mismo'. Que haces?</p>"
            ...
            + "<label style='display:block;padding:4px 0'><input type='radio' name='q1' value='3'> Responder pidiendo mas informacion</label>"
            + "<p style='font-weight:700;color:#334155;font-size:14px;margin:14px 0 6px'>2. Que debes revisar antes de confiar en un enlace?</p>"
            + "<label style='display:block;padding:4px 0'><input type='radio' name='q2' value='1'> Que el boton se vea grande y de confianza</label>"
            ...
            + "<p style='font-weight:700;color:#334155;font-size:14px;margin:14px 0 6px'>3. Cual es el mejor canal para verificar un aviso raro?</p>"
            + "<label style='display:block;padding:4px 0'><input type='radio' name='q3' value='1'> Llamar al numero del propio correo</label>"
            + "<label style='display:block;padding:4px 0'><input type='radio' name='q3' value='2'> Responder al remitente</label>"
            + "<label style='display:block;padding:4px 0'><input type='radio' name='q3' value='3'> El canal oficial: telefono de la organizacion o portal conocido</label>"
            ...
            + "var msg=(n===3)?'Excelente, 3 de 3. Ya puedes detectar este tipo de engano.':('Respuestas correctas: '+n+' de 3. Repasa las senales de arriba.');"
