...
export type CampaignStats = { totalRecipients: number; sentSoFar: number; percent: number; schedulingActive: boolean; etaMinutes: number; totalSent: number; totalOpened: number; totalClicked: number; totalSubmitted: number; totalReported: number; totalTrainingViewed: number; totalTrainingCompleted: number; openRate: number; clickRate: number; submitRate: number; trainingRate: number }
...
export type SendingProgress = { id?: number; name?: string; totalRecipients: number; sentSoFar: number; percent: number; schedulingActive: boolean; etaMinutes: number }
export type Dashboard = { activeCampaigns: number; totalCampaigns: number; totalSent: number; totalOpened: number; totalClicked: number; totalSubmitted: number; totalReported: number; totalTrainingViewed: number; totalTrainingCompleted: number; recentCampaigns: { id: number; name: string; status: string; createdAt: string }[]; activeSendingCampaigns: SendingProgress[] }
